            ...
            <div class="navbar-start">
                <div class="dropdown">
                    ...
                    <ul tabindex="0"
                        ...
                        <li v-if="user"><Link :href="route('logout')" method="post" as="button" class="text-error">Logout</Link></li>
                        <li v-else><Link :href="route('login')">Login</Link></li>
                    </ul>
                </div>
                <Link :href="route('landing-page')" class="btn btn-ghost text-xl">launchPad</Link>
            </div>

            <div class="navbar-center hidden lg:flex">
                <ul class="menu menu-horizontal px-1">
                    <li v-if="user"><Link :href="route('dashboard')">Dashboard</Link></li>
                    <li><Link href="/features">Features</Link></li>
                    <li><Link href="/pricing">Pricing</Link></li>
                    <li><Link href="/blog">Blog</Link></li>
                    <li v-if="user"><Link :href="route('logout')" method="post" as="button" class="text-error">Logout</Link></li>
